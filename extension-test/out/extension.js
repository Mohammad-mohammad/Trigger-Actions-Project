...
function activate(context) {
    context.subscriptions.push(vscode.commands.registerCommand('trigger-actions.openWebview', () => {
        const panel = vscode.window.createWebviewPanel('triggerActions', 'Trigger Actions', vscode.ViewColumn.One, {
            enableScripts: true,
        });
